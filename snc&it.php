<?php
    include("dbcon.php");
    $sql = "SELECT Regid, Cname,Photo FROM student WHERE Post='Science and IT Secretary';";
...
<body>
    ...
    <?php include('nav.php'); ?>
    <div class="title">
        <h1 class="gs">Science and IT Secretary</h1>
...
<?php }?><?php mysqli_close($con);?>
    ...
    <footer class="info">
        <h3 class="sectiontag" style="color: rgb(28, 28, 46);">Know Your Science and IT Secretary</h3>
        <p>Student Representation: The Science and IT Secretary serves as the voice of the student body, advocating for their interests, concerns, and needs to the college administration and faculty.
            ...
            Facilitating Communication: The Science and IT Secretary facilitates communication between students, faculty, and administration by conveying information, concerns, and suggestions between these groups.
            ...
            Fostering Student Engagement: The Science and IT Secretary ourages student participation in college activities, clubs, and initiatives to enhance the overall student experience.
            ...
            Collaborating with Other Officers: They collaborate with other student council officers, such as the President, Vice President, and Science and IT Secretary, to achieve common goals and objectives.</p>
    </footer>
</section>
</body>
</html>