...
<?php
    include("dbcon.php");
    $sql = "SELECT Regid, Cname,Photo FROM student WHERE Post='Treasurer';";
...
<?php }?><?php mysqli_close($con);?>
    ...
    <footer class="info">
        <h3 class="sectiontag" style="color: rgb(28, 28, 46);">Know Your Treasurer</h3>
        <p>Student Representation: The Treasurer serves as the voice of the student body, advocating for their interests, concerns, and needs to the college administration and faculty.
            ...
            Facilitating Communication: The Treasurer facilitates communication between students, faculty, and administration by conveying information, concerns, and suggestions between these groups.
            ...
            Fostering Student Engagement: The Treasurer ourages student participation in college activities, clubs, and initiatives to enhance the overall student experience.
